...
public class BusinessForTagExpire implements Runnable{
	...
	public BusinessForTagExpire(TimlyPojo tp, CachePojo<String, UnitPojo, AreaPojo, DevicePojo, TagPojo, RulePojo, TimlyPojo, VehiclePojo> cache, int unitIndex){
		this.tp = tp;
		this.cache = cache;
	...
	public void run(){
		...
		try{
			...
			String sql = "update tb_" + unitIndex + "_tag set expire = true where tagId = '" + tagId + "'";
